    ...
    <section id="portfolio" className="reveal section-padding relative w-full overflow-hidden" aria-labelledby="portfolio-heading">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 relative">
        <div className="flex flex-col items-center mb-20 text-center">
          ...
          <h2 className="heading-2 mb-6" id="portfolio-heading">Recent Work That Drives Results</h2>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3" id="portfolio-grid">
          {visibleProjects.map((project, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 portfolio-gradient" aria-hidden="true" />
