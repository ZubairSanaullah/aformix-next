...
interface PermanentDeletePostButtonProps {
    postId: string;
}

export default function PermanentDeletePostButton({
    postId,
}: PermanentDeletePostButtonProps) {
    ...
    async function handleDelete() {
        try {
            const response = await fetch(`/api/posts/${postId}/permanent`, {
                method: "DELETE",
            });
            ...
            toast.success("Post permanently deleted from your workspace.");
