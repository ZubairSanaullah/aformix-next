...
interface FinanceCategoryDetailActionsProps {
    categoryId: string;
}

export default function FinanceCategoryDetailActions({
    categoryId,
}: FinanceCategoryDetailActionsProps) {
    ...
    const handleArchive = async () => {
        ...
        try {
            const response = await fetch(
                `/api/finance/categories/${categoryId}/archive`,
                {
                    method: "POST",
                }
            );
    ...
    const handleRestore = async () => {
        ...
        try {
            const response = await fetch(
                `/api/finance/categories/${categoryId}/restore`,
                {
                    method: "POST",
                }
            );
